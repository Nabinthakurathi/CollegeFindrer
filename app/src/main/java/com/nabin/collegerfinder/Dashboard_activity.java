...
import com.nabin.collegerfinder.Adapter.ImageSliderAdapter;
import com.nabin.collegerfinder.Adapter.ItemRecyclerAdapter;
import com.nabin.collegerfinder.Api.UsersApi;
import com.nabin.collegerfinder.Bll.BannerBll;
    ...
    public void navigations(){
        ...
        NV.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (id)
                {
                    case R.id.Home: startActivity(new Intent(Dashboard_activity.this, College_List.class));
                        return false;
                    case R.id.BBA: startActivity(new Intent(Dashboard_activity.this, BBA_Activity.class));
                        return false;
                    case R.id.IT :startActivity(new Intent(Dashboard_activity.this, it_Activity.class));
                        return false;
                    case R.id.userprofile :startActivity(new Intent(Dashboard_activity.this, UserProfile_avtivity.class));
                        return false;
                    ...
                    case R.id.Map :startActivity(new Intent(Dashboard_activity.this, MapsActivity.class));
                    default:
    ...
    public void circleImageViewClick(){
        ...
        logos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity( new Intent(Dashboard_activity.this,College_List.class));
            }
        });
