...
public class UserProfile_avtivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_profile_avtivity);
    ...
    private  void ShowDetails() {
        ...
        userDetails.enqueue(new Callback<User>() {
            ...
            public void onFailure(Call<User> call, Throwable t) {
                Toast.makeText(UserProfile_avtivity.this, "Error" + t.getLocalizedMessage(), Toast.LENGTH_LONG).show();
    ...
    private void profileupdate() {
        ...
        userDetails.enqueue(new Callback<User>() {
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                ...
                etusername.setText(response.body().getUsername());
                Picasso.get().load(url.imagePath + response.body().getImage()).into(profileimg);
                Toast.makeText(UserProfile_avtivity.this, "Successful", Toast.LENGTH_SHORT).show();
            }
